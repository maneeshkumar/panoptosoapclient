 ...
 *         &lt;element name="request" type="{http://schemas.datacontract.org/2004/07/Panopto.Server.Services.PublicAPI.V40}ListSessionsRequest" minOccurs="0"/>
...
@XmlRootElement(name = "GetSessionsList")
public class GetSessionsList {
    ...
    protected JAXBElement<ListSessionsRequest> request;
     ...
     * 
     * @return possible object is {@link JAXBElement }{@code <}{@link ListSessionsRequest }{@code >}
     * 
     */
    public JAXBElement<ListSessionsRequest> getRequest() {
        return request;
    }
     ...
     * 
     * @param value allowed object is {@link JAXBElement }{@code <}{@link ListSessionsRequest }{@code >}
     * 
     */
    public void setRequest(JAXBElement<ListSessionsRequest> value) {
        this.request = value;
    }
