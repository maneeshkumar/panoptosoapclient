...
@XmlType(name = "", propOrder = {"auth", "sessionId", "inheritViewerAccess"})
@XmlRootElement(name = "UpdateSessionInheritViewerAccess")
public class UpdateSessionInheritViewerAccess {
