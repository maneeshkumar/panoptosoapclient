 ...
 *         &lt;element name="parameters" type="{http://schemas.datacontract.org/2004/07/Panopto.Server.Services.PublicAPI.V40}ListUsersRequest" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {"auth", "parameters", "searchQuery"})
...
public class ListUsers {
    ...
    protected JAXBElement<ListUsersRequest> parameters;
     ...
     * 
     * @return possible object is {@link JAXBElement }{@code <}{@link ListUsersRequest }{@code >}
     * 
     */
    public JAXBElement<ListUsersRequest> getParameters() {
        return parameters;
    }
     ...
     * 
     * @param value allowed object is {@link JAXBElement }{@code <}{@link ListUsersRequest }{@code >}
     * 
     */
    public void setParameters(JAXBElement<ListUsersRequest> value) {
