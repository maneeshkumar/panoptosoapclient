 ...
 *         &lt;element name="sessionIds" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOfguid" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {"auth", "sessionIds", "folderId"})
@XmlRootElement(name = "MoveSessions")
public class MoveSessions {
    ...
    @XmlElementRef(name = "sessionIds", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfguid> sessionIds;
     ...
     * 
     */
    public JAXBElement<ArrayOfguid> getSessionIds() {
        return sessionIds;
    }
     ...
     * 
     */
    public void setSessionIds(JAXBElement<ArrayOfguid> value) {
