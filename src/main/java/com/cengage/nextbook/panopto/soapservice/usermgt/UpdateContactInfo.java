 ...
 *         &lt;element name="sendNotifications" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = {"auth", "userId", "firstName", "lastName", "email", "sendNotifications"})
@XmlRootElement(name = "UpdateContactInfo")
