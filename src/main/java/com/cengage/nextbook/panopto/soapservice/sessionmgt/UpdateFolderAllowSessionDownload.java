...
@XmlType(name = "", propOrder = {"auth", "folderId", "allowSessionDownload"})
@XmlRootElement(name = "UpdateFolderAllowSessionDownload")
public class UpdateFolderAllowSessionDownload {
