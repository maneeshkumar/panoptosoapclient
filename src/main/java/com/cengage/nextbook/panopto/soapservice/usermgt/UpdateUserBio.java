...
@XmlType(name = "", propOrder = {"auth", "userId", "bio"})
@XmlRootElement(name = "UpdateUserBio")
public class UpdateUserBio {
    ...
    @XmlElementRef(name = "bio", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
